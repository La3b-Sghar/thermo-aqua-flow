					...
					<div className="flex flex-col md:flex-row items-center">
						<div className="md:w-1/2 mb-10 md:mb-0 md:pr-10">
							...
							<p className="text-lg text-gray-700 mb-8 leading-relaxed">
								Our innovative solution uses Stirling motors to generate
								electricity from high-temperature wastewater (25–90°C) and
								treats the water using advanced phytoremediation technology.
							</p>
						...
						<div className="md:w-1/2">
							<div className="relative">
								...
								<div className="relative bg-white shadow-xl rounded-xl overflow-hidden animate-flow">
									<img
										src="https://theyarnbazaar.com/assets/images/blogs/textile-industry-in-india.webp"
				...
				<div className="container mx-auto">
					<div className="max-w-3xl mx-auto text-center mb-16">
						...
						<p className="text-lg text-gray-700">
							Combining Stirling motors with phytoremediation for a complete
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
						<div>
							...
							<p className="text-gray-700 mb-4">
								Our Stirling motors harness the temperature difference between
								hot wastewater (25-90°C) and the ambient environment to generate
								clean electricity without emissions or additional fuel.
							</p>
							<ul className="space-y-2">
								<li className="flex items-start">
									...
									<span>
										Generates <strong>5-20 kW</strong> per unit depending on
								...
								<li className="flex items-start">
									...
									<span>
										Minimally invasive installation into existing facilities
									</span>
								</li>
								<li className="flex items-start">
									<svg
						...
						<div>
							...
							<p className="text-gray-700 mb-4">
								Our plant-based water treatment system uses specialized
								vegetation to remove contaminants from wastewater, providing a
								natural, energy-efficient cleaning process.
							</p>
							<ul className="space-y-2">
								<li className="flex items-start">
									<svg
									...
									<span>
										Removes <strong>heavy metals</strong>, organic compounds,
										and pharmaceuticals
									</span>
								</li>
								<li className="flex items-start">
									...
									<span>
										Reduces water treatment costs by up to <strong>40%</strong>
									</span>
								</li>
								<li className="flex items-start">
									<svg
			...
			<section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50 scroll-animation">
				<div className="container mx-auto">
					<div className="max-w-3xl mx-auto text-center mb-16">
						...
						<p className="text-lg text-gray-700">
							Reduce costs, improve sustainability, and meet regulatory
							requirements with our integrated solution.
						</p>
					</div>
						...
						<div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
							...
							<ul className="space-y-2">
								...
								<li className="flex items-start">
									...
									<span className="text-gray-700">
										Lower water treatment expenses
									</span>
								</li>
								<li className="flex items-start">
									<svg
						...
						{[...Array(1)].map((_, index) => (
							...
							>
								<div className="w-full h-full flex items-center justify-center bg-gray-100 rounded">
									...
									<img
										src="https://www.envibat.se/templates/envibat/img/Logo.svg"
										alt=""
									/>
								</div>
							</div>
				...
				<div className="container mx-auto">
					<div className="max-w-3xl mx-auto text-center">
						...
						<p className="text-xl mb-8 opacity-90">
							Join the growing number of manufacturing facilities that are
